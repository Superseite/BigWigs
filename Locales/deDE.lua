...
--L.PRIVATE_desc = "Private Auren können nicht normal verfolgt werden, aber der \"auf dir\" Sound (Warnung) kann im Reiter Sounds aktiviert werden. Private auras can't be tracked normally, but the \"on you\" sound (Warning) can be set in the Sound tab."
